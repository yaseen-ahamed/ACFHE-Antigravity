...
export function Diploma() {
    return (
        <PageTransition>
            <SEO
                title="Diploma in Culinary Skills in Kerala | ACFHE"
                description="Enroll in the CTH UK-accredited Diploma in Culinary Skills at ACFHE Kerala. 12-month program with 6 months of mandatory internship for a global hospitality career."
                keywords="culinary diploma in kerala, chef courses in kerala, diploma in culinary skills, cth accredited hospitality courses india"
            />
            {/* Hero */}
            <section className="pt-32 pb-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto relative overflow-hidden">
                ...
                >
                    ...
                    <p className="text-[#4B5563] max-w-2xl mx-auto text-lg leading-relaxed mb-8 font-medium">
                        A comprehensive full-time program. Builds on basic cookery skills to introduce advanced techniques and senior kitchen tasks.
                    </p>
                    <div className="flex flex-col sm:flex-row justify-center items-center gap-4">
                        <Link to="/admissions" className="btn-primary flex items-center shadow-lg w-full sm:w-auto justify-center">
                            Apply for Diploma <ArrowRight className="ml-2 w-4 h-4" />
                        </Link>
                        ...
                        >
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-10">
                                ...
                                <div className="flex items-start gap-4 p-6 bg-white rounded-2xl border border-gray-100 shadow-sm">
                                    ...
                                    <div>
                                        ...
                                        <div className="text-sm text-[#1E1E1E] font-bold">18–35 years</div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="bg-[#B8952A]/10 p-6 rounded-2xl border border-[#B8952A]/20">
                                ...
                                <p className="text-sm text-[#4B5563] font-medium leading-relaxed">
                                    Globally recognized qualification enabling international mobility and career progression.
                                </p>
                            </div>
                        </motion.div>
